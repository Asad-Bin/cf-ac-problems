...
int main()
{
	...
	for(int K=0; K<n; K++){
		//cout << upper_bound(ara, ara+n, (s[K]=='0'?ara[K]+k:ara[K]+k-1))-ara << ' ';
		//cout << lower_bound(ara, ara+n, (s[K]=='0'?ara[K]+k:ara[K]+k-1))-ara << "\n";
		
		int it = upper_bound(ara+K, ara+n, (s[K]=='0'?ara[K]+k:ara[K]+k-1))-lower_bound(ara+K, ara+n, (s[K]=='0'?ara[K]+k:ara[K]+k-1));
		ans += (it);
		//cout << K << ' ' << it << ' ' << ans << "\n";
	}
