...
void task()
{
	...
	while(t--){
		...
		ara.resize(n);
		for(int K=0; K<n; K++) cin >> ara[K].a >> ara[K].b >> ara[K].c >> ara[K].d >> ara[K].e;
		
		
		v = ara;
		sort(all(ara), f);
		
		//for(int K=0; K<n; K++) cout << ara[K].a << ' ' << ara[K].b << ' ' << ara[K].c << ' ' << ara[K].d << ' ' << ara[K].e << "\n";
